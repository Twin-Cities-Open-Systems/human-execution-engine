...
|---|---|---|---|
| **Doctrine / Blueprints** | `blueprints/` | Authoritative, non-terminal (`result: false`), changes must be deliberate and minimal | [`docs/BLUEPRINT_RULES.md`](BLUEPRINT_RULES.md) |
