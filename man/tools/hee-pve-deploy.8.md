...
# SYNOPSIS
    ...
    options:
      ...
      --node NODE
      --host HOST
      --dry-run          resolve the manifest and print every command that would
                         run -- create, add-ons, files, provision -- creating and
                         changing nothing. Without it the deploy is applied.
