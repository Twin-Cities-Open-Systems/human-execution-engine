% HEE-QUOTA(1) | HEE Tools

# NAME

hee-quota - hee-quota: monitor GitHub API rate-limit pools (core/graphql/search) and

# SYNOPSIS

    hee-quota [-h] {status,warn,wait,watch} ...
